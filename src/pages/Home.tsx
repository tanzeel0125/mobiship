...
import { Package, MapPin, Search, QrCode, FileText, RotateCcw, Gift, Shield, ChevronRight, CheckCircle2 } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="mobile-shell pb-20">
      <MobiShipTopNav />
      <div className="px-4 py-4 space-y-4 page-enter">
        ...
        <div className="relative">
          ...
          <input
            ...
            readOnly
          />
          <button onClick={() => navigate('/track')} className="absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 bg-accent rounded-lg flex items-center justify-center">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button onClick={() => navigate('/ship')} className="bg-navy rounded-xl p-4 text-left btn-press">
          ...
          <button onClick={() => navigate('/track')} className="bg-gradient-to-br from-accent to-accent-hover rounded-xl p-4 text-left btn-press">
        ...
        <div className="bg-card rounded-xl shadow-card p-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-medium">{user?.location || '10000 Eldorado Drive, San Marcos, CA 92069'}</p>
          </div>
        ...
        <div className="bg-card rounded-xl shadow-card p-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-medium bg-success/10 text-success px-2 py-0.5 rounded-full">Included</span>
            </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            <button onClick={() => navigate('/orders')} className="w-full bg-card rounded-xl shadow-card p-4 flex items-center gap-3 btn-press text-left">
              ...
              <span className="text-xs font-medium text-accent flex items-center gap-1">Show Orders <ChevronRight size={14} /></span>
            </button>
            <button onClick={() => navigate('/return')} className="w-full bg-card rounded-xl shadow-card p-4 flex items-center gap-3 btn-press text-left">
              ...
              <span className="text-xs font-medium text-accent flex items-center gap-1">Start a Return <ChevronRight size={14} /></span>
            </button>
          </div>
        </div>

        {/* Refer */}
        <button onClick={() => navigate('/referrals')} className="w-full bg-navy rounded-xl p-4 flex items-center gap-3 btn-press text-left">
          ...
          <div className="flex-1">
            ...
            <p className="text-primary-foreground/60 text-xs">Invite friends and get $5 in shipping credit!</p>
          </div>
